...
const TransactionPage = () => {
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		const amount = parseFloat(formData.amount);  //covert amount into number bcoz by default it is strig and the reason it's coming from an input field
		try {
	...
	useEffect(()=>{
		if(data){
			setFormData({
				...
				category: data?.transaction.category,
				amount: data?.transaction.amount,
				location: data?.transaction.locatio ,
